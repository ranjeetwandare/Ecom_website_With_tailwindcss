      ...
      <div className=" grid xl:grid-cols-3 xl:grid-row-2 gap-8">
        <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
          ...
          <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-4">
            ...
            <p className="text-gray-500 text-xl pt-4 pt-4 sm:pt-8">
              Starting At
            </p>
            <div className="font-medium text-red-600 text-2xl sm:text-4xl sm:pb-8 pb-4">
              $20.10
            </div>
            <div className="bg-accentDark hover:bg-accent text-white rounded-full w-fit flex items-center gap-3 py-2 text-[14px]sm:px-7 sm:py-3 cursor-pointer">
        ...
        <div className="relative">
          ...
          <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[20%] -translate-y-[50%] sm:space-y-2">
            <h2 className="text-2xl  sm:text-3xl font-bold">
              Best Yummy Pizza
            </h2>
            <p className="text-white-500 text-xl pt-4 ">Starting At</p>
