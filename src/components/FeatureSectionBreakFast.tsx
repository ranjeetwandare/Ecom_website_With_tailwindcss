...
const data =[
  ...
  {id:1, img: "product__3.webp",name: "Crunchy Crisps", price: "$200"},
  {id:2, img: "product__2.webp",name: "Jewel Ceanberries", price: "$400"},
  {id:3, img: "product__1.webp",name: "Almond organic", price: "$100"}
  ...
  return (
    <div className="container pt-16">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 pt-8 gap-2">
        <div>
          <img src="/feature__2.webp" alt="banner" 
          />
        </div>
